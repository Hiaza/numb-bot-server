...
public class SerializationUtils {
    ...
    public static final String[] DATETIME_FORMAT_STRINGS = {JacksonUtils.DATETIME_FORMAT_STRING, "yyyy-MM-dd'T'HH:mm:ssZZZZZ", "yyyy-MM-dd'T'HH:mm:ssZZZZZ", "yyyy-MM-dd'T'HH:mm:ss.SSSZZZZZ", "yyyy-MMM-dd'T'HH:mm:ss.SSSZZZZZ", "yyyy-MM-dd HH:mm:ssZZZZZ"};
